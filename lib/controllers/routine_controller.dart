...
class RoutineController with ChangeNotifier {
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            ...
            explanation:
                'Mantén la espalda recta, baja hasta que las rodillas formen un ángulo de 90°. Sube lentamente.',
            imagePath: 'assets/images/squats.png',
          ),
          SubExercise(
            name: 'Zancadas - 3x8',
            explanation:
                'Da un paso adelante, baja la rodilla trasera casi al suelo, y regresa a la posición inicial.',
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            ...
            explanation:
                'Sostén las mancuernas, flexiona los codos y sube el peso hacia los hombros.',
            imagePath: 'assets/images/bicep_curl.png',
          ),
          SubExercise(
            name: 'Tricep Dips - 3x10',
            explanation:
                'Apoya las manos en un banco, baja el cuerpo flexionando los codos, y sube.',
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            name: 'Dominadas - 3x8',
            explanation:
                'Cuelga de una barra, sube hasta que la barbilla pase la barra, y baja controladamente.',
            imagePath: 'assets/images/pull_ups.png',
          ),
          SubExercise(
            name: 'Remo con barra - 3x10',
            explanation:
                'Inclínate, jala la barra hacia el abdomen, y baja con control.',
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            name: 'Plancha - 3x30s',
            explanation:
                'Mantén el cuerpo en línea recta, apoyado en antebrazos y puntas de pies.',
            imagePath: 'assets/images/plank.png',
          ),
          SubExercise(
            name: 'Russian Twists - 3x20',
            explanation:
                'Siéntate, inclínate ligeramente y gira el torso de lado a lado con un peso.',
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            ...
            explanation:
                'Añade peso en los hombros, baja a 90° y sube con control.',
            imagePath: 'assets/images/weighted_squats.png',
          ),
          SubExercise(
            name: 'Prensa de piernas - 4x10',
            explanation:
                'Usa la máquina, empuja el peso con los pies y regresa lentamente.',
      ...
      RoutineModel(
        ...
        subExercises: [
          SubExercise(
            ...
            explanation:
                'Usa un peso significativo, baja controladamente y sube con fuerza.',
  ...
  void toggleCompletion(RoutineModel routine, SubExercise subExercise) {
    ...
    if (index != -1) {
      final subIndex =
          _routines[_selectedLevel]![index].subExercises.indexOf(subExercise);
      if (subIndex != -1) {
        _routines[_selectedLevel]![index].subExercises[subIndex].isCompleted =
            !_routines[_selectedLevel]![index]
                .subExercises[subIndex]
                .isCompleted;
        _routines[_selectedLevel]![index].isCompleted =
            _routines[_selectedLevel]![index]
                .subExercises
                .every((se) => se.isCompleted);
        notifyListeners();
      }
    }
  }
