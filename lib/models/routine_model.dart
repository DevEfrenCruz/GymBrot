class RoutineModel {
  ...
  factory RoutineModel.fromJson(Map<String, dynamic> json) {
    return RoutineModel(
      ...
      subExercises: (json['subExercises'] as List<dynamic>)
...
class SubExercise {
  ...
  factory SubExercise.fromJson(Map<String, dynamic> json) {
    return SubExercise(
      ...
      isCompleted: json['isCompleted'] as bool? ?? false,
      explanation:
          json['explanation'] as String? ?? 'Sin explicación disponible',
      imagePath:
          json['imagePath'] as String? ?? 'assets/images/placeholder.png',
    );
  }
}
